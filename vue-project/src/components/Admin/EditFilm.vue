        ...
        <div class="subtitle is-4 has-text-white">
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            <input
              ...
              placeholder="title"
            />
            <p class="help is-white" v-if="title.length == 0">
              enter your title
            </p>
            <p
              class="help is-danger"
              v-if="title.length > 0 && title.length < 5"
            >
              * enter 5 character at least
            </p>
          </div>
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            <input
              ...
              placeholder="trailer"
            />
            <p class="help is-white" v-if="trailer.length == 0">
              enter your trailer
            </p>
          </div>
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            />
            <p class="help is-white" v-if="dir_fname.length == 0">
              enter your director first name
            </p>
            <p
              class="help is-danger"
              v-if="dir_fname.length > 0 && dir_fname.length < 5"
            >
              * enter 5 character at least
            </p>
          </div>
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            />
            <p class="help is-white" v-if="dir_lname.length == 0">
              enter your director last name
            </p>
            <p
              class="help is-danger"
              v-if="dir_lname.length > 0 && dir_lname.length < 5"
            >
              * enter 5 character at least
            </p>
          </div>
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            <input
              ...
              placeholder="year"
            />
            <p class="help is-white" v-if="year.length == 0">
              enter movie year
            </p>
            <p
              class="help is-danger"
              v-if="isNaN(this.year) || (year.length < 4 && year.length > 0)"
            >
              * 4 Number Only and character
            </p>
          </div>
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            <input
              ...
              placeholder="time"
            />
            <p class="help is-white" v-if="time.length == 0">
              enter time movie
            </p>
          ...
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            <textarea
              ...
              placeholder="story"
            ></textarea>
            <p class="help is-white" v-if="story.length == 0">
              enter your Story movie
            </p>
            <p
              class="help is-danger"
              v-if="story.length > 0 && story.length < 30"
            >
              * enter 30 character at least
            </p>
          </div>
          <div class="ml-3" style="margin-bottom: 40px">
            ...
            <input
              ...
              v-model="poster"
            />
            <p class="help is-white" v-if="poster.length == 0">
              enter your poster
            </p>
          </div>
        </div>
  ...
  <div v-show="swapPage">
    <div class="columns">
      <div class="column is-three-fifths is-offset-one-fifth">
        <h1 class="has-text-centered is-size-1 pt-4">Add Actor</h1>
        <div class="table-container my-6 ml-4">
              ...
              <tr>
                ...
                <td>
                  <div class="has-text-centered">
                    <button
                      class="button is-success is-hovered"
                      type="submit"
                      @click="crudMovStore.addActor(actor)"
                    >
                      Add
                    </button>
                  </div>
        ...
        <div class="columns mt-6">
          <div class="column has-text-centered">
            <router-link to="/">
              <button
                style="width: 100%"
                class="button is-danger is-light subtitle is-5"
                type="cancel"
              >
                DONE
              </button>
          ...
          <div class="column has-text-centered">
            <button
              @click="swapPage = !swapPage"
              style="width: 90%"
              class="button subtitle is-primary is-light is-5"
              type="cancel"
            >
              ADD MORE MOVIE
            </button>
  ...
  computed: {
    check() {
      return (
        ...
        this.trailer == "" ||
        this.dir_fname == "" ||
        this.dir_fname.length < 5 ||
        this.dir_lname == "" ||
        this.dir_lname.length < 5 ||
        isNaN(this.year) ||
        this.year == "" ||
        this.poster == "" ||
        this.story == "" ||
        this.story.length < 30 ||
        this.type == "" ||
        this.genres == 0 ||
        isNaN(this.time) ||
        this.time == ""
